...
export const products: Product[] = [
  ...
  { id: "18", name: "LG UltraGear 34\" QHD 165Hz Curved",       brand: "LG",           cat: "Monitors",       price: 189000, old: 210000, rating: 56,  inStock: true,  img: monitor },
  { id: "19", name: "HyperX Cloud III Wireless Headset",        brand: "HyperX",       cat: "Headsets",       price: 22500,  old: 25000,  rating: 67,  inStock: true,  img: headset },
  { id: "20", name: "Logitech G Pro X Superlight 2",             brand: "Logitech",     cat: "Mice",           price: 34999,  old: 38999,  rating: 89,  inStock: true,  img: mouse },
  { id: "21", name: "ASUS ROG Strix G16 RTX 4070",             brand: "ASUS",         cat: "Laptops",        price: 499000, old: 549000, rating: 34,  inStock: true,  img: laptop },
...
export const ALL_CATEGORIES = [...new Set(products.map((p) => p.cat))].sort();
export const ALL_BRANDS = [...new Set(products.map((p) => p.brand))].sort();
export const GLOBAL_MIN = Math.min(...products.map((p) => p.price));
export const GLOBAL_MAX = Math.max(...products.map((p) => p.price));
