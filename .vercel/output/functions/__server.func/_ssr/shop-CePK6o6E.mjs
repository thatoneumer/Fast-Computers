...
import { R as Route$a } from "./router-Bg1cmQxE.mjs";
import "../_libs/seroval.mjs";
import "../_libs/sweetalert2.mjs";
import { f as SlidersHorizontal, g as ArrowUpDown, H as Heart, a as ShoppingCart, S as Star, R as RotateCcw, X, c as ChevronDown } from "../_libs/lucide-react.mjs";
...
function FilterContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-5 scrollbar-thin", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FilterSection, { title: "Brand", children: brands.map((brand) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        FilterCheckbox,
        {
          label: brand,
...
function ShopPage() {
  const productsList = Route$a.useLoaderData();
  ...
  const ALL_BRANDS = reactExports.useMemo(() => [...new Set(productsList.map((p) => p.brand))].sort(), [productsList]);
  ...
  const [selectedCategories, setSelectedCategories] = reactExports.useState(categoryParam ? [categoryParam] : []);
  ...
  const activeCount = selectedCategories.length + selectedBrands.length + (inStockOnly ? 1 : 0) + (priceMin !== GLOBAL_MIN || priceMax !== GLOBAL_MAX ? 1 : 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShopFilter, { categories: ALL_CATEGORIES, brands: ALL_BRANDS, selectedCategories, selectedBrands, priceMin, priceMax, globalMin: GLOBAL_MIN, globalMax: GLOBAL_MAX, inStockOnly, activeCount, isOpen: filterOpen, onClose: () => setFilterOpen(false), onCategoryToggle: toggleCategory, onBrandToggle: toggleBrand, onPriceChange: (min, max) => {
          setPriceMin(min);
          setPriceMax(max);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 px-5 lg:px-8 py-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 mb-8 pb-5 border-b border-border", children: [
            ...
            activeCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden flex flex-wrap gap-1.5 w-full", children: [
              ...
              selectedBrands.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => toggleBrand(b), className: "flex items-center gap-1 text-[10px] uppercase tracking-widest bg-primary/15 border border-primary/30 text-primary px-2 py-1 hover:bg-primary/25 transition-colors", children: [
                b,
                " ×"
              ] }, b)),
          ...
          activeCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex flex-wrap gap-1.5 mb-6", children: [
            ...
            selectedBrands.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => toggleBrand(b), className: "flex items-center gap-1 text-[10px] uppercase tracking-widest bg-primary/15 border border-primary/30 text-primary px-2.5 py-1 hover:bg-primary/25 transition-colors", children: [
              b,
              " ×"
            ] }, b)),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            ...
            p.inStock && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-label": "Add to wishlist", className: "absolute top-2 right-2 z-10 w-7 h-7 sm:w-8 sm:h-8 border border-border bg-background/60 backdrop-blur flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:text-primary hover:border-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square overflow-hidden bg-secondary/30", children: [
              ...
              p.inStock && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "w-full bg-primary text-primary-foreground py-3 text-[11px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors", children: [
