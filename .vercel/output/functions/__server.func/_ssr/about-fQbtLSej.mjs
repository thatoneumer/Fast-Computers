...
import { _ as Trophy, a8 as Users, S as Star, a9 as Calendar, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
function AboutPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 py-20 grid lg:grid-cols-2 gap-16 items-center", style: {
        perspective: "1200px"
      }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          transformStyle: "preserve-3d"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 8, scale: 1.03, className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border slash-bg", style: {
        perspective: "1200px"
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        rotateX: 10,
        transformPerspective: 1200
      }, whileInView: {
        ...
        transformStyle: "preserve-3d"
      }, className: "mx-auto max-w-7xl px-6 py-16 grid grid-cols-2 md:grid-cols-4 gap-6", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        y: 30,
        rotateX: 15,
        ...
        transformStyle: "preserve-3d"
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 10, scale: 1.05, className: "text-center border border-border bg-card p-8 hover:border-primary transition group h-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 py-24 text-center", style: {
        perspective: "1000px"
      }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
          ...
          delay: 0.2,
          duration: 0.6
        }, className: "mt-4 max-w-xl mx-auto text-muted-foreground", children: "Configure a custom prebuilt gaming PC, choose components from our curated parts lists, or message our engineers to plan your dream hardware setup." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          opacity: 0,
          y: 20
        }, whileInView: {
          ...
          delay: 0.35,
          duration: 0.6
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", className: "mt-8 inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 font-bold uppercase tracking-widest text-sm red-glow hover:brightness-110 transition", children: [
