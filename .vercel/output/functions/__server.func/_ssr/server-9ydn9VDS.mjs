...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C59KVMdE.mjs");
...
const manifest = {
  "0fb8bf0af5955b789c6fec9b8774c9453e8a8a74704b6506827c4d846b5d445b": {
    ...
    importer: () => import("./auth-DtcFdIRm.mjs")
  },
  ...
  "24c7a133b54ac5045a58146c82e749a196cd2e5730afcdf64763a37203db36d2": {
    ...
    importer: () => import("./products-B5vAzKhs.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CQJSMlrt.mjs").then((n) => n.r),
    import("./start-DH5Zv3yJ.mjs"),
