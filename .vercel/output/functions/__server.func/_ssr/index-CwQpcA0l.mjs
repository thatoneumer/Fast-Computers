...
import { t as Route$2, u as useCartWishlist } from "./router-B3L3dKbz.mjs";
...
import { A as ArrowRight, ad as BadgeCheck, w as ShieldCheck, x as Truck, R as RotateCcw, y as Sparkles, z as Layers, B as Cpu, D as MemoryStick, G as HardDrive, J as MousePointer2, N as Headphones, O as Keyboard, Q as Monitor, Z as Zap, V as Box, W as Snowflake, $ as Wrench, a1 as Trophy, ae as Flame, d as ChevronRight, af as PackageCheck, ag as Headset, i as CreditCard, S as Star, I as Instagram, q as Phone, m as Mail, h as MapPin, H as Heart, a as ShoppingCart } from "../_libs/lucide-react.mjs";
...
function GamingPCs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 sm:gap-6", children: pcs.map((pc, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      y: 40,
      rotateX: 12,
      transformPerspective: 1e3
      ...
      transformStyle: "preserve-3d"
    }, className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 6, scale: 1.03, className: `h-full relative border p-8 group ${i === 1 ? "border-primary bg-card red-border-glow" : "border-border bg-card"}`, children: [
