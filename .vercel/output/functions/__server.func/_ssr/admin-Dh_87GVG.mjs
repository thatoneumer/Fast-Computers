...
import { f as Route$4, a as useAuth, h as getAllOrdersFn, i as seedProductsFn, j as deleteProductFn, k as updateOrderStatusFn, l as updateProductFn, m as createProductFn, n as uploadImageToCloudinaryFn } from "./router-DCoJxg4b.mjs";
import { S as Swal } from "../_libs/sweetalert2.mjs";
import "../_libs/seroval.mjs";
import { $ as RefreshCw, a0 as ShieldAlert, s as Plus, q as ShoppingBag, P as Package, a1 as TriangleAlert, w as Layers, S as Star, b as Search, a2 as Filter, a3 as Pen, T as Trash2, g as MapPin, m as Phone, h as CreditCard, u as Truck, a4 as CircleX, a5 as CircleCheck, X, a6 as Image, a7 as CloudUpload } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 py-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full gap-2 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("products"), className: `flex-1 flex items-center justify-center px-4 py-3 font-bold text-xs uppercase tracking-widest transition ${activeTab === "products" ? "bg-primary text-primary-foreground red-glow" : "bg-card/60 border border-border text-foreground hover:border-primary"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-4 h-4 mr-2" }),
            "Products"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setActiveTab("orders"), className: `flex-1 flex items-center justify-center px-4 py-3 font-bold text-xs uppercase tracking-widest transition ${activeTab === "orders" ? "bg-primary text-primary-foreground red-glow" : "bg-card/60 border border-border text-foreground hover:border-primary"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4 h-4 mr-2" }),
            "Orders"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12", children: [{
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card/40 p-4 mb-6 flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4", children: [
        ...
        activeTab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filteredProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card p-16 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border-collapse", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden", children: filteredProducts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card p-4 flex flex-col justify-between hover:border-primary/50 transition", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 bg-background border border-border overflow-hidden shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.img, alt: "", className: "w-full h-full object-cover" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm text-foreground line-clamp-2", children: p.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mt-1", children: [
                  p.brand,
                  " · ",
                  p.cat
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-baseline gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-sm text-primary", children: [
                    "PKR ",
                    p.price.toLocaleString()
                  ] }),
                  p.old > p.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground line-through font-normal", children: [
                    "PKR ",
                    p.old.toLocaleString()
                  ] })
                ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-4 pt-3 border-t border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex items-center text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 border ${p.inStock ? "bg-green-500/10 border-green-500/30 text-green-500" : "bg-primary/10 border-primary/20 text-primary"}`, children: p.inStock ? "In Stock" : "Out of Stock" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => openForm(p), className: "px-3 py-1.5 border border-border bg-background hover:border-primary hover:text-primary transition text-xs font-bold uppercase tracking-wider flex items-center gap-1.5", title: "Edit product", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { className: "w-3 h-3" }),
                  " Edit"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleDeleteProduct(p), className: "px-3 py-1.5 border border-border bg-background hover:border-primary hover:text-primary transition text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 text-primary", title: "Delete product", children: [
        ...
        activeTab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: ordersLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card overflow-hidden", children: [
            ...
            ordersList.filter((o) => o.status === "pending").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center text-muted-foreground", children: "No pending orders" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: ordersList.filter((o) => o.status === "pending").map((order) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 hover:bg-card/30 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start justify-between gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground text-sm truncate", title: order.email, children: order.email })
                  ] })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:items-end gap-3 mt-4 lg:mt-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap sm:flex-nowrap gap-2 w-full justify-start sm:justify-end", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleUpdateOrderStatus(order._id, "shipped"), className: "w-full sm:w-auto bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 text-xs font-bold uppercase tracking-wider transition flex items-center justify-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { className: "w-4 h-4" }),
                    " Mark Shipped"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleCancelOrder(order), className: "w-full sm:w-auto bg-red-500 hover:bg-red-600 text-white px-4 py-2 text-xs font-bold uppercase tracking-wider transition flex items-center justify-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card overflow-hidden", children: [
            ...
            ordersList.filter((o) => o.status === "shipped").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center text-muted-foreground", children: "No shipped orders" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: ordersList.filter((o) => o.status === "shipped").map((order) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 hover:bg-card/30 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start justify-between gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Order Number" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-foreground", children: order.orderNumber })
                  ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:items-end gap-3 mt-4 lg:mt-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => handleUpdateOrderStatus(order._id, "delivered"), className: "w-full sm:w-auto bg-green-500 hover:bg-green-600 text-white px-4 py-2 text-xs font-bold uppercase tracking-wider transition flex items-center justify-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card overflow-hidden", children: [
            ...
            ordersList.filter((o) => o.status === "delivered").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center text-muted-foreground", children: "No delivered orders" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: ordersList.filter((o) => o.status === "delivered").map((order) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 hover:bg-card/30 transition", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start justify-between gap-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:items-end gap-3 mt-4 lg:mt-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full sm:w-auto bg-green-500/10 border border-green-500/30 text-green-500 px-3 py-1 text-xs font-bold uppercase tracking-wider text-center font-semibold", children: "Completed" })
              ] })
            ] }) }, order._id)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card overflow-hidden", children: [
            ...
            ordersList.filter((o) => o.status === "cancelled").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center text-muted-foreground", children: "No cancelled orders" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/60", children: ordersList.filter((o) => o.status === "cancelled").map((order) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 hover:bg-card/30 transition opacity-60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start justify-between gap-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:items-end gap-3 mt-4 lg:mt-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full sm:w-auto bg-red-500/10 border border-red-500/30 text-red-500 px-3 py-1 text-xs font-bold uppercase tracking-wider text-center font-semibold", children: "Cancelled" })
              ] })
            ] }) }, order._id)) })
          ] })
        ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isFormOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center px-4 overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleFormSubmit, className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border border-border bg-background/20 p-4 rounded red-border-glow", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-2 border-t border-border/50", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    ...
                    formImages.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2 border border-border/50 bg-background/40 p-2 rounded", children: formImages.map((url, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-square relative border border-border/80 bg-background overflow-hidden group rounded", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border bg-background/50 p-3 max-h-[220px] overflow-y-auto space-y-2", children: formSpecs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-6 text-xs text-muted-foreground uppercase tracking-wider", children: "No specifications added yet." }) : formSpecs.map((spec, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", required: true, value: spec.label, onChange: (e) => updateSpecRow(index, "label", e.target.value), placeholder: "e.g. Memory Size", className: "flex-1 min-w-0 bg-background border border-border px-2 py-1.5 text-xs outline-none focus:border-primary transition" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", required: true, value: spec.value, onChange: (e) => updateSpecRow(index, "value", e.target.value), placeholder: "e.g. 16GB GDDR6X", className: "flex-1 min-w-0 bg-background border border-border px-2 py-1.5 text-xs outline-none focus:border-primary transition" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-6 flex flex-col sm:flex-row justify-end gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setIsFormOpen(false), className: "w-full sm:w-auto border border-border bg-background hover:border-primary hover:text-primary font-bold text-xs uppercase tracking-widest px-6 py-3.5 transition text-center", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", disabled: isSubmitting, className: "w-full sm:w-auto bg-primary hover:brightness-110 disabled:opacity-50 text-primary-foreground font-bold text-xs uppercase tracking-widest px-8 py-3.5 red-glow transition flex items-center justify-center gap-2", children: [
