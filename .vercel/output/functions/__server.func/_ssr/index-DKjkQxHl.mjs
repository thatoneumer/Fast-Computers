...
import { S as SiteHeader, a as SiteFooter } from "./SiteFooter-7t1eysUO.mjs";
import { S as Swal } from "../_libs/sweetalert2.mjs";
import { o as Route$2, u as useCartWishlist } from "./router-DCoJxg4b.mjs";
import { T as Tilt3D } from "./Tilt3D-vyU3Qaxk.mjs";
...
function Categories() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "shop", className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4", children: cats.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      y: 30,
      rotateX: 12,
      transformPerspective: 1e3
      ...
      transformStyle: "preserve-3d"
    }, className: "aspect-square", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tilt3D, { maxTilt: 10, scale: 1.05, className: "w-full h-full border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
      category: c.name,
      categories: void 0
    }, className: "absolute inset-0 group", children: [
...
function ProductCard({
  ...
  const handleMouseMove = (e) => {
    ...
    const targetX = -3 - relY * 4;
    const targetY = 4 + relX * 2;
    tiltX.set(targetX);
    tiltY.set(targetY);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/product/$id", params: {
    ...
    once: true,
    amount: 0.15
  }, whileHover: animate3D ? "hover" : {
    y: -8
  }, onMouseEnter: handleMouseEnter, onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave, style: {
    transformStyle: animate3D ? "preserve-3d" : void 0,
...
function Featured({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4", style: {
      perspective: "1000px"
    }, children: products.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { ...p, i, animate3D: true }, p.name)) })
  ] });
}
...
function DealBanners() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-2 gap-4 sm:gap-6", style: {
    ...
    transformStyle: "preserve-3d"
  }, className: "group relative overflow-hidden border border-border", style: {
    minHeight: "360px"
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tilt3D, { maxTilt: 5, scale: 1.02, className: "h-full w-full relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: d.link, className: "absolute inset-0 flex flex-col justify-end p-6 sm:p-10", children: [
...
function Newsletter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-5 sm:mt-8 flex flex-col gap-3 max-w-md mx-auto", onSubmit: (e) => e.preventDefault(), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", placeholder: "you@yourdomain.com", className: "w-full bg-background border border-border px-4 py-3 sm:py-4 text-sm outline-none focus:border-primary transition" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-full bg-primary text-primary-foreground px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-sm hover:brightness-110 red-glow transition", children: "Subscribe" })
      ] })
    ] })
  ] }) });
}
