...
import { u as useCartWishlist, a as useAuth, c as createOrderFn } from "./router-DSghCXlz.mjs";
import "../_libs/seroval.mjs";
import { U as User, h as MapPin, i as CreditCard, o as ShoppingBag, p as Minus, q as Plus, T as Trash2, r as ShieldCheck, s as Truck, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
Thank you for your purchase. We'll contact you shortly to confirm your order.`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
            ...
            opacity: 1,
            y: 0
          }, className: "bg-card border border-border p-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          delay: 0.3
        }, className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border p-6 sticky top-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-xl font-bold uppercase flex items-center gap-2 mb-6", children: [
