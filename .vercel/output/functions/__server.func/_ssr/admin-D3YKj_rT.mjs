...
import { h as Route$4, a as useAuth, i as getAllOrdersFn, j as getAllReviewsFn, k as seedProductsFn, l as getProductsFn, m as deleteProductFn, n as deleteReviewFn, o as updateProductFn, p as createProductFn, q as uploadImageToCloudinaryFn, r as updateOrderStatusFn } from "./router-B3L3dKbz.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0 lg:min-h-screen", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 overflow-y-auto p-4 sm:p-6", children: [
        ...
        activeTab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/[0.02] border border-yellow-500/20 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-yellow-500/10 px-5 py-3 flex items-center gap-2 border-b border-yellow-500/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/[0.02] border border-blue-500/20 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-blue-500/10 px-5 py-3 flex items-center gap-2 border-b border-blue-500/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/[0.02] border border-green-500/20 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-500/10 px-5 py-3 flex items-center gap-2 border-b border-green-500/10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/[0.02] border border-primary/20 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 px-5 py-3 flex items-center gap-2 border-b border-primary/10", children: [
