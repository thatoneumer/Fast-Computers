...
import { k as Route$1, u as useCartWishlist } from "./router-fsufY5hA.mjs";
import { g as gpu, m as mobo, a as mouse, h as headset, k as keyboardImg, b as monitor, l as laptop } from "./products-data-LRMOsjPP.mjs";
import "../_libs/seroval.mjs";
import "../_libs/sweetalert2.mjs";
import { u as useScroll, a as useTransform } from "../_libs/framer-motion.mjs";
import { d as ArrowRight, ah as BadgeCheck, J as ShieldCheck, N as Truck, t as RotateCcw, O as Sparkles, L as Layers, C as Cpu, Q as MemoryStick, V as HardDrive, W as MousePointer2, H as Headphones, K as Keyboard, M as Monitor, Z as Zap, _ as Box, S as Snowflake, a0 as Wrench, a2 as Trophy, F as Flame, q as ChevronRight, ai as PackageCheck, aj as Headset, v as CreditCard, i as Star, n as Instagram, w as Phone, x as Mail, u as MapPin, g as Heart, e as ShoppingCart } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref, className: "relative min-h-screen overflow-hidden pt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-6 py-24 lg:py-32 min-h-[calc(100vh-5rem)] flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsPCBuilderOpen(true), className: "inline-flex items-center gap-2 border border-border px-8 py-4 font-bold uppercase tracking-widest text-sm hover:border-primary hover:text-primary transition", children: "Custom Build" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0
      }, animate: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "build", className: "relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 py-24 grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsPCBuilderOpen(true), className: "mt-10 inline-flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 font-bold uppercase tracking-widest text-sm red-glow hover:brightness-110 transition", children: [
          "Start Building ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
        ] })
      ] }),
...
function GamingPCs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 py-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: pcs.map((pc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsPCBuilderOpen(true), className: "mt-6 w-full border border-border py-3 font-bold uppercase tracking-widest text-xs hover:border-primary hover:text-primary transition flex items-center justify-center gap-2", children: [
        "Configure ",
