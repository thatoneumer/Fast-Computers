...
import { t as Route$2, u as useCartWishlist } from "./router-Dpz7ddGE.mjs";
import { T as Tilt3D } from "./Tilt3D-BKhZYuCs.mjs";
import { s as sendEmail } from "./email-CrmUIKV1.mjs";
import "../_libs/seroval.mjs";
import { b as useScroll, c as useTransform, u as useMotionValue, a as useSpring } from "../_libs/framer-motion.mjs";
import { A as ArrowRight, ad as BadgeCheck, w as ShieldCheck, x as Truck, R as RotateCcw, y as Sparkles, z as Layers, B as Cpu, D as MemoryStick, G as HardDrive, J as MousePointer2, N as Headphones, O as Keyboard, Q as Monitor, Z as Zap, V as Box, W as Snowflake, $ as Wrench, a1 as Trophy, ae as Flame, af as PackageCheck, ag as Headset, i as CreditCard, S as Star, d as ChevronRight, I as Instagram, q as Phone, m as Mail, h as MapPin, H as Heart, a as ShoppingCart } from "../_libs/lucide-react.mjs";
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref, className: "relative min-h-screen overflow-hidden pt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24 lg:py-32 min-h-[calc(100vh-5rem)] flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl w-full", children: [
      ...
      }, className: "mt-4 sm:mt-6 text-4xl xs:text-5xl sm:text-6xl md:text-8xl font-bold leading-[0.9] uppercase", children: [
        "Game Without",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
        ...
        delay: 0.4,
        duration: 0.6
      }, className: "mt-4 sm:mt-8 text-sm sm:text-lg text-muted-foreground max-w-md", children: "High performance PCs & accessories engineered for gamers and creators who refuse to settle." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        delay: 0.55
      }, className: "mt-6 sm:mt-10 flex flex-col xs:flex-row items-stretch xs:items-center gap-3 xs:gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
          category: void 0,
          categories: void 0
        }, className: "group inline-flex items-center justify-center gap-3 bg-primary text-primary-foreground px-5 sm:px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-xs sm:text-sm red-glow hover:brightness-110 transition", children: [
          "Shop Now ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => Swal.fire({
          ...
          icon: "info"
        }), className: "inline-flex items-center justify-center gap-2 border border-border px-5 sm:px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-xs sm:text-sm hover:border-primary hover:text-primary transition", children: "Custom Build" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tilt3D, { maxTilt: 6, scale: 1.03, className: "mt-8 sm:mt-16 max-w-lg border-t border-border pt-5 sm:pt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0
      }, animate: {
        opacity: 1
      }, transition: {
        delay: 0.8,
        duration: 0.6
      }, className: "grid grid-cols-3 gap-2 xs:gap-4 sm:gap-8", children: [["15K+", "Builds Shipped"], ["4.9★", "Customer Rating"], ["24/7", "Support"]].map(([n, l]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg xs:text-2xl sm:text-3xl font-display font-bold text-primary", children: n }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] xs:text-[10px] sm:text-xs uppercase tracking-widest text-muted-foreground mt-1 leading-snug", children: l })
      ] }, l)) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0
...
function FeatureStrip() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(motion.section, { initial: {
    ...
    transformStyle: "preserve-3d"
  }, className: "border-y border-border bg-card/40 slash-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-10 grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-6", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 6, scale: 1.03, className: "flex items-center gap-2 sm:gap-4 group min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 flex-shrink-0 flex items-center justify-center border border-primary/40 text-primary group-hover:red-border-glow transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold uppercase text-[10px] xs:text-xs sm:text-sm tracking-wide truncate", children: it.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] xs:text-[10px] sm:text-xs text-muted-foreground truncate", children: it.desc })
    ] })
  ] }, it.title)) }) });
}
function Categories() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "shop", className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    perspective: "1000px"
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, className: "flex items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionKicker, { label: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 sm:mt-4 text-3xl sm:text-4xl md:text-5xl font-bold uppercase", children: [
          "Shop by ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Category" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground max-w-md", children: "Browse high-end computing components and gear built for peak performance." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/categories", className: "inline-flex items-center gap-2 text-xs sm:text-sm uppercase tracking-widest text-primary hover:gap-3 transition-all", children: [
        "View All ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4", children: cats.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full border border-border bg-card overflow-hidden group hover:-translate-y-1 hover:border-primary transition-all duration-300 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
      category: c.name,
      categories: void 0
    }, className: "absolute inset-0 z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: c.img, alt: c.name, className: "absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-70 group-hover:scale-110 transition-all duration-300", loading: "lazy" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 h-0.5 bg-primary w-0 group-hover:w-full transition-all duration-300" })
    ] }) }) }, c.name)) })
  ] });
}
const cardVariants = {
...
function ProductCard({
  ...
  const randomRotateY = reactExports.useRef(Math.random() * 16 - 8).current;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/product/$id", params: {
    ...
    display: "block",
    transformStyle: animate3D ? "preserve-3d" : void 0
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: animate3D ? cardVariants : void 0, custom: {
    randomRotateY,
    i
  }, initial: animate3D ? "hidden" : {
    opacity: 0,
    y: 30
  }, whileInView: animate3D ? "visible" : {
    opacity: 1,
    y: 0
  }, viewport: {
    once: true,
    amount: 0.15
  }, whileHover: animate3D ? void 0 : {
    y: -8
  }, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, style: {
    transformStyle: animate3D ? "preserve-3d" : void 0,
    rotateX: animate3D ? springX : void 0,
    rotateY: animate3D ? springY : void 0
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square overflow-hidden bg-background", style: {
      transformStyle: animate3D ? "preserve-3d" : void 0
    }, children: [
      animate3D ? /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: img, alt: name, className: "w-full h-full object-cover", loading: "lazy", style: {
        transformStyle: "preserve-3d"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 sm:p-4 flex flex-col gap-1.5 sm:gap-2", style: {
      transformStyle: animate3D ? "preserve-3d" : void 0
    }, children: [
...
function Featured({
  ...
  if (productsList.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
      ...
      duration: 0.8
    }, className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, className: "flex items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground max-w-md", children: "Our recommended gaming gear and hardware, tested and approved." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
          category: void 0,
          categories: void 0
        }, className: "inline-flex items-center gap-2 text-xs sm:text-sm uppercase tracking-widest text-primary hover:gap-3 transition-all", children: [
          "View All Products ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-[3px] border-transparent border-t-primary border-r-primary animate-spin", style: {
          animationDuration: "1.2s"
        } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 rounded-full border border-primary/20" })
      ] }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.section, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4", children: products.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { ...p, i, animate3D: false }, p.name)) })
  ] });
}
function CustomBuilder() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "build", className: "relative overflow-hidden", style: {
    perspective: "1000px"
  }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24 grid lg:grid-cols-2 gap-8 sm:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionKicker, { label: "Configurator" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 sm:mt-4 text-3xl sm:text-4xl md:text-6xl font-bold uppercase leading-tight", children: [
          "Build Your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Perfect" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Gaming Rig"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 sm:mt-6 text-sm sm:text-base text-muted-foreground max-w-md", children: "Pick every component. From CPU to case lighting. Our engineers assemble, stress test, and ship your dream machine." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 sm:mt-8 grid grid-cols-2 gap-3 sm:gap-4 max-w-md", children: [[Wrench, "Expert Assembly"], [Zap, "72h Stress Test"], [ShieldCheck, "2 Yr Warranty"], [Trophy, "Award Winning"]].map(([Icon, label], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs sm:text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary flex-shrink-0" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => Swal.fire({
          ...
          text: "Custom build feature is coming soon!",
          icon: "info"
        }), className: "mt-6 sm:mt-10 inline-flex items-center gap-3 bg-primary text-primary-foreground px-5 sm:px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-xs sm:text-sm red-glow hover:brightness-110 transition", children: [
          "Start Building ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        ...
        transformStyle: "preserve-3d"
      }, className: "relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 6, scale: 1.03, className: "w-full h-full", children: [
...
function FlashSale({
  ...
  if (productsList.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
      perspective: "1200px"
      ...
      transformStyle: "preserve-3d"
    }, className: "relative border border-primary/50 bg-gradient-to-br from-primary/10 via-card to-card p-5 xs:p-8 md:p-14 red-border-glow overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "absolute -top-8 -right-8 w-48 h-48 text-primary/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-6 sm:gap-8 items-center relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 sm:mt-4 text-sm sm:text-base text-muted-foreground max-w-md", children: "Up to 40% off on selected gaming rigs, peripherals and monitors. Ends soon." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 sm:mt-8 flex gap-2 sm:gap-3", children: [["Hours", time.h], ["Mins", time.m], ["Secs", time.s]].map(([l, v]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border p-2 xs:p-3 sm:p-4 min-w-[56px] xs:min-w-[70px] sm:min-w-[80px] text-center flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
              scale: 0.8,
              opacity: 0.5
            }, animate: {
              scale: 1,
              opacity: 1
            }, className: "text-xl xs:text-2xl sm:text-3xl font-display font-bold text-primary", children: String(v).padStart(2, "0") }, v),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] sm:text-xs uppercase tracking-widest text-muted-foreground mt-1", children: l })
          ] }, l)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-[3px] border-transparent border-t-primary border-r-primary animate-spin", style: {
            animationDuration: "1.2s"
          } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 rounded-full border border-primary/20" })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-6 sm:gap-8 items-center relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 sm:mt-8 flex gap-2 sm:gap-3", children: [["Hours", time.h], ["Mins", time.m], ["Secs", time.s]].map(([l, v]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background border border-border p-2 xs:p-3 sm:p-4 min-w-[56px] xs:min-w-[70px] sm:min-w-[80px] text-center flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] xs:text-[10px] uppercase tracking-widest text-muted-foreground mt-1", children: l })
        ] }, l)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
          category: void 0,
          categories: void 0
        }, className: "mt-5 sm:mt-8 inline-flex items-center gap-3 bg-primary text-primary-foreground px-5 sm:px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-xs sm:text-sm hover:brightness-110 transition", children: [
          "Shop the Sale ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: saleProducts.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 10, scale: 1.04, className: "relative aspect-square bg-background border border-border overflow-hidden group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.img, alt: p.name, className: "w-full h-full object-cover group-hover:scale-110 transition animate-glow-pulse", loading: "lazy" }),
...
function GamingPCs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, className: "text-center mb-8 sm:mb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground max-w-xl mx-auto", children: "Three tiers. Zero compromise. Ships in 48 hours." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-[3px] border-transparent border-t-primary border-r-primary animate-spin", style: {
        animationDuration: "1.2s"
...
function DealBanners() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-2 gap-4 sm:gap-6", style: {
    perspective: "1200px"
  }, children: [{
    title: "Peripherals",
    ...
    transformStyle: "preserve-3d",
    minHeight: "360px"
  }, className: "group relative overflow-hidden border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tilt3D, { maxTilt: 5, scale: 1.02, className: "h-full w-full relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: d.link, className: "absolute inset-0 flex flex-col justify-end p-6 sm:p-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: d.img, alt: d.title, className: "absolute inset-0 w-full h-full object-cover object-center opacity-50 group-hover:opacity-70 group-hover:scale-105 transition-all duration-700", loading: "lazy" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] sm:text-xs uppercase tracking-[0.3em] text-primary font-semibold mb-2", children: d.tag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl sm:text-4xl md:text-5xl font-bold uppercase leading-none", children: d.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-sm text-muted-foreground", children: d.sub }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 inline-flex items-center gap-2 text-xs sm:text-sm uppercase tracking-widest font-bold border-b border-transparent group-hover:border-primary group-hover:text-primary transition-all duration-300", children: [
        "Shop Now ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
      ] })
    ] })
...
function WhyUs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border", children: perks.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      y: 30,
      rotateX: 10,
      transformPerspective: 1e3
      ...
      transformStyle: "preserve-3d"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 6, scale: 1.03, className: "bg-background p-8 group hover:bg-card transition h-full border border-border md:border-0", children: [
...
function Testimonials() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 sm:gap-6", children: reviews.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      y: 30,
      rotateX: 12,
      ...
      transformStyle: "preserve-3d"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 7, scale: 1.03, className: "border border-border bg-card p-8 hover:border-primary transition h-full", children: [
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24 grid lg:grid-cols-2 gap-8 sm:gap-12", style: {
    perspective: "1000px"
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 sm:mt-6 text-sm sm:text-base text-muted-foreground max-w-md", children: "Can't find what you're looking for? Reach out — real humans, fast responses." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#contact", className: "mt-4 sm:mt-6 inline-flex items-center gap-2 text-xs sm:text-sm uppercase tracking-widest text-primary", children: [
        "Contact Support ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" })
      ] })
    ] }),
...
function Newsletter() {
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); padding: 30px; border-radius: 8px; border: 2px solid #c41e3a;">
              ...
              <div style="color: #ffffff; line-height: 1.6;">
                ...
                <p style="margin: 10px 0;"><strong style="color: #c41e3a;">Date:</strong> ${(/* @__PURE__ */ new Date()).toLocaleString()}</p>
              </div>
            </div>
          </div>
        `
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    opacity: 0,
    rotateX: 10,
    scale: 0.97,
    transformPerspective: 1e3
    ...
    transformStyle: "preserve-3d"
  }, className: "relative border border-primary/40 red-border-glow p-6 xs:p-10 md:p-16 text-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 sm:mt-4 text-3xl sm:text-4xl md:text-5xl font-bold uppercase max-w-2xl mx-auto", children: [
        "Get Early Access ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "& Deals" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 sm:mt-4 text-sm sm:text-base text-muted-foreground max-w-md mx-auto", children: "Drop your email — new drops, restocks, and members-only pricing straight to your inbox." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "mt-5 sm:mt-8 flex flex-col gap-3 max-w-md mx-auto", onSubmit: handleSubmit, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "email", placeholder: "you@yourdomain.com", value: email, onChange: (e) => setEmail(e.target.value), required: true, disabled: isSubmitting, className: "w-full bg-background border border-border px-4 py-3 sm:py-4 text-sm outline-none focus:border-primary transition disabled:opacity-50" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: isSubmitting, className: "w-full bg-primary text-primary-foreground px-8 py-3 sm:py-4 font-bold uppercase tracking-widest text-sm hover:brightness-110 red-glow transition disabled:opacity-50 disabled:cursor-not-allowed", children: isSubmitting ? "Subscribing..." : "Subscribe" })
      ] })
    ] })
  ] }) });
}
function Gallery() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp3D, className: "text-center mb-8 sm:mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground", children: "Tag your setup with #FastRigs to be featured." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1 sm:gap-2", children: shots.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      opacity: 0,
      scale: 0.9,
      rotateX: 10,
      rotateY: i % 2 === 0 ? -8 : 8,
      ...
      transformStyle: "preserve-3d"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tilt3D, { maxTilt: 8, scale: 1.04, className: "group relative aspect-square overflow-hidden border border-border block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "block w-full h-full", children: [
...
function ContactCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-3 gap-3 sm:gap-4", style: {
    perspective: "1200px"
  }, children: [{
    icon: Phone,
    title: "Call Us",
  ...
  }].map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
    opacity: 0,
    y: 30,
    rotateX: 14,
    ...
    transformStyle: "preserve-3d"
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 8, scale: 1.04, className: "border border-border bg-card p-8 hover:border-primary transition group h-full", children: [
...
function Home() {
  const productsList = Route$2.useLoaderData();
