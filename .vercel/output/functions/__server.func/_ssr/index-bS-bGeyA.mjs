...
import { m as Route$2, u as useCartWishlist } from "./router-SoUVH66f.mjs";
import "../_libs/seroval.mjs";
import { u as useScroll, a as useTransform, b as useMotionValue, c as useSpring } from "../_libs/framer-motion.mjs";
import { A as ArrowRight, aa as BadgeCheck, u as ShieldCheck, v as Truck, R as RotateCcw, w as Sparkles, x as Layers, C as Cpu, y as MemoryStick, z as HardDrive, B as MousePointer2, D as Headphones, G as Keyboard, J as Monitor, Z as Zap, N as Box, O as Snowflake, W as Wrench, _ as Trophy, ab as Flame, e as ChevronRight, ac as PackageCheck, ad as Headset, i as CreditCard, S as Star, I as Instagram, n as Phone, j as Mail, h as MapPin, H as Heart, a as ShoppingCart } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref, className: "relative min-h-screen overflow-hidden pt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24 lg:py-32 min-h-[calc(100vh-5rem)] flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        ...
        delay: 0.8,
        duration: 0.6
      }, className: "mt-8 sm:mt-16 grid grid-cols-3 gap-2 xs:gap-4 sm:gap-8 max-w-lg border-t border-border pt-5 sm:pt-8", children: [["15K+", "Builds Shipped"], ["4.9★", "Customer Rating"], ["24/7", "Support"]].map(([n, l]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function Categories() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "shop", className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "flex items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6 flex-wrap", children: [
...
function FlashSale({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "relative border border-primary/50 bg-gradient-to-br from-primary/10 via-card to-card p-5 xs:p-8 md:p-14 red-border-glow overflow-hidden", children: [
...
function GamingPCs() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "text-center mb-8 sm:mb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 sm:gap-6", children: pcs.map((pc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0,
      y: 40
    }, whileInView: {
      opacity: 1,
...
function DealBanners() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-2 gap-4 sm:gap-6", children: [{
    title: "Peripherals",
    ...
    minHeight: "360px"
  }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: d.link, className: "absolute inset-0 flex flex-col justify-end p-6 sm:p-10", children: [
...
function Testimonials() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-4 sm:gap-6", children: reviews.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      opacity: 0,
      y: 30
    }, whileInView: {
      opacity: 1,
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24 grid lg:grid-cols-2 gap-8 sm:gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, children: [
...
function Newsletter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "relative border border-primary/40 red-border-glow p-6 xs:p-10 md:p-16 text-center overflow-hidden", children: [
...
function Gallery() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { ...fadeUp, className: "text-center mb-8 sm:mb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1 sm:gap-2", children: shots.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.a, { href: "#", initial: {
      opacity: 0,
      scale: 0.9
    }, whileInView: {
      opacity: 1,
...
function ContactCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-3 gap-3 sm:gap-4", children: [{
    icon: Phone,
    title: "Call Us",
    val: "+92 300 1234567",
