...
import { s as sections, p as products } from "./products-data-LRMOsjPP.mjs";
import { a as useAuth, u as useCartWishlist, m as getProductsFn } from "./router-fsufY5hA.mjs";
import { j as Search, X, g as Heart, U as User, k as ChevronDown, P as Package, l as LogOut, e as ShoppingCart, m as Menu, n as Instagram, Y as Youtube, o as Twitter, p as Facebook, d as ArrowRight } from "../_libs/lucide-react.mjs";
...
function SiteHeader() {
  ...
  const { cart, wishlist, setIsPCBuilderOpen } = useCartWishlist();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `fixed top-0 inset-x-0 z-50 border-b border-border/60 transition-colors duration-300 ${scrolled ? "bg-background" : isHome ? "bg-transparent" : "bg-background"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mx-auto max-w-7xl px-6 flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-20"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-2xl font-display font-bold tracking-widest", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden lg:flex items-center gap-8 text-sm font-semibold tracking-wide uppercase", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: "relative group text-primary font-bold hover:text-primary transition animate-glow-pulse uppercase cursor-pointer",
            children: [
              "Build Your PC",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 h-0.5 w-0 bg-primary transition-all group-hover:w-full" })
            ]
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden border-t border-border bg-background/95", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "px-6 py-4 flex flex-col gap-3 text-sm uppercase font-semibold tracking-wide", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "py-1 text-primary font-bold hover:text-primary text-left uppercase cursor-pointer",
...
function SiteFooter() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border bg-card/30", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-16 grid md:grid-cols-2 lg:grid-cols-5 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-display font-bold tracking-widest", children: [
          "F",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "/" }),
          "AST ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-[0.3em] text-muted-foreground ml-2", children: "COMPUTERS" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground max-w-xs", children: "High performance PCs, custom builds and gaming gear for those who refuse to compromise." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-3", children: [Instagram, Youtube, Twitter, Facebook].map((I, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "w-10 h-10 border border-border flex items-center justify-center hover:border-primary hover:text-primary transition", children: /* @__PURE__ */ jsxRuntimeExports.jsx(I, { className: "w-4 h-4" }) }, i)) })
      ] }),
