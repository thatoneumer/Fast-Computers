...
import { a as useAuth } from "./router-DCoJxg4b.mjs";
import "../_libs/seroval.mjs";
import "../_libs/sweetalert2.mjs";
import { Z as Zap, t as ShieldCheck, _ as Trophy, U as User, i as Mail, k as Lock, l as EyeOff, E as Eye, j as LoaderCircle, A as ArrowRight } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[calc(100vh-5rem)] grid lg:grid-cols-2 overflow-hidden", style: {
      perspective: "1400px"
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      }, className: "relative hidden lg:flex flex-col justify-between p-16 border-r border-border overflow-hidden slash-bg", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 space-y-4", children: [{
          ...
          }].map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
            opacity: 0,
            x: -30,
            rotateY: 10,
            transformPerspective: 800
            ...
            transformStyle: "preserve-3d"
          }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tilt3D, { maxTilt: 6, scale: 1.03, className: "flex gap-4 border border-border bg-card/50 backdrop-blur p-4 hover:border-primary transition", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        ...
        transformStyle: "preserve-3d"
      }, className: "relative flex items-center justify-center p-6 sm:p-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          perspective: "1000px"
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { initial: {
          opacity: 0,
          rotateY: mode === "signup" ? 90 : -90,
