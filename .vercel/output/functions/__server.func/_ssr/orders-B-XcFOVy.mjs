...
import { R as ReviewModal } from "./ReviewModal-DjtgILFQ.mjs";
import { a as useAuth, g as getOrdersFn, b as getUserReviewedProductsFn } from "./router-B3L3dKbz.mjs";
...
function OrdersPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-4 mb-4", children: ["all", "processing", "shipped", "delivered"].map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setStatusFilter(key), className: `px-3 py-1 rounded ${statusFilter === key ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`, children: key === "all" ? "All" : key.charAt(0).toUpperCase() + key.slice(1) }, key)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", children: [
