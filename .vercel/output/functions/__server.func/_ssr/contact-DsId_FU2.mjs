...
import { c as generateContactEmailHTML } from "./router-BjSOlR78.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-6 py-20 grid lg:grid-cols-2 gap-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { initial: {
          ...
          duration: 0.6
        }, onSubmit: handleSubmit, className: "relative border border-border bg-card p-8 md:p-10 red-border-glow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
