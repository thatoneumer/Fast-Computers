import { c as createServerRpc, a as connectToDatabase } from "./mongodb-C2k3MQhM.mjs";
import { c as createServerFn } from "./server-CTzAty7X.mjs";
...
const googleLoginFn = createServerFn({
  ...
  try {
    ...
    const redirectUri = process.env.VITE_APP_URL ? `${process.env.VITE_APP_URL}/api/auth/google/callback` : "http://localhost:3000/api/auth/google/callback";
