...
import { S as SiteHeader, a as SiteFooter } from "./SiteFooter-CvgNYXvf.mjs";
import { S as Swal } from "../_libs/sweetalert2.mjs";
import { k as Route$1, u as useCartWishlist } from "./router-Bg1cmQxE.mjs";
...
function Featured({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4", children: products.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { ...p, i }, p.name)) })
  ] });
}
...
function DealBanners() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-24 grid md:grid-cols-2 gap-4 sm:gap-6", children: [{
    ...
    duration: 0.6
  }, className: "group relative overflow-hidden border border-border aspect-[16/9] flex items-end p-4 sm:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", search: {
