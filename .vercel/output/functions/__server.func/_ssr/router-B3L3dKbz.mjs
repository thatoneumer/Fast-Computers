...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-Y9zJBdke.mjs";
...
const appCss = "/assets/styles-g49ezTKx.css";
...
const submitReviewFn = createServerFn({
  ...
  return data;
}).handler(createSsrRpc("cc7f0b539efc233c6e6b88b9f6dabafe4cea28730793acb66cf76c80cfbb5835"));
const getReviewsFn = createServerFn({
  method: "GET"
}).validator((data) => data).handler(createSsrRpc("e2ee6585b1728381aa555d35d6c5a5c860d5083b154005bcf471a86cf1ca5fb1"));
const getUserReviewedProductsFn = createServerFn({
  method: "GET"
}).validator((data) => data).handler(createSsrRpc("945488d270b1df2f5ec3e796060c88f0b2e58349a7767548aff664a49bf82ec4"));
const getAllReviewsFn = createServerFn({
  method: "GET"
}).handler(createSsrRpc("11c9376692fed1b9062d923132f3f70f9742b7c4011beb72b59596e6e3794c4f"));
const deleteReviewFn = createServerFn({
  method: "POST"
}).validator((data) => data).handler(createSsrRpc("991e79803e91f4828d9752bda16890df22ebfe199325a5dd11347e41d429cd78"));
...
const $$splitComponentImporter$d = () => import("./wishlist-Dzmf1tuZ.mjs");
...
const $$splitComponentImporter$c = () => import("./shop-EKVxpZT0.mjs");
...
const $$splitComponentImporter$b = () => import("./orders-B-XcFOVy.mjs");
...
const $$splitComponentImporter$a = () => import("./forgot-password-BKk4n-Al.mjs");
...
const $$splitComponentImporter$9 = () => import("./contact-CJCUsPpu.mjs");
...
const $$splitComponentImporter$8 = () => import("./checkout-6oAGZEbl.mjs");
...
const $$splitComponentImporter$7 = () => import("./categories-DNzXMHPF.mjs");
...
const $$splitComponentImporter$6 = () => import("./cart-DBgOhaue.mjs");
...
const $$splitComponentImporter$5 = () => import("./auth-BZLkNmI8.mjs");
...
const $$splitComponentImporter$4 = () => import("./admin-D3YKj_rT.mjs");
...
const $$splitComponentImporter$3 = () => import("./about-8_m69XXn.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-CwQpcA0l.mjs");
...
const $$splitComponentImporter$1 = () => import("./product._id-B_p9eupJ.mjs");
...
const $$splitComponentImporter = () => import("./auth_.google.callback-ajFltf5w.mjs");
...
export {
  generateWelcomeEmailHTML as A,
  router as B,
  Route$c as R,
  useAuth as a,
  getUserReviewedProductsFn as b,
  verifyOtpAndResetPasswordFn as c,
  generateContactEmailHTML as d,
  createOrderFn as e,
  generateOrderEmailHTML as f,
  getOrdersFn as g,
  Route$4 as h,
  getAllOrdersFn as i,
  getAllReviewsFn as j,
  seedProductsFn as k,
  getProductsFn as l,
  deleteProductFn as m,
  deleteReviewFn as n,
  updateProductFn as o,
  createProductFn as p,
  uploadImageToCloudinaryFn as q,
  updateOrderStatusFn as r,
  sendResetOtpFn as s,
  Route$2 as t,
