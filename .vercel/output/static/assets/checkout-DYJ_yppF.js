import{u as S,b as P,d as T,r as N,j as e,m as g,A as O,L as M,e as F,f as w}from"./index-D_IgYfGU.js";import{S as E,U as $,a as q}from"./SiteFooter-DYssU2Qw.js";import{P as R}from"./PageHero-DB2ugWM7.js";import{M as z}from"./map-pin-Ck2kFY-L.js";import{C as L}from"./credit-card-D8U-6HTS.js";import{S as A}from"./shopping-bag-Bq5RhKkI.js";import{M as D}from"./minus-CX5WcIev.js";import{P as K}from"./plus-DI2Cj8Kj.js";import{T as U}from"./trash-2-CQsTqT2z.js";import{S as I}from"./shield-check-nNsQD11f.js";import{T as H}from"./truck-ivQk7Mtk.js";import"./chevron-right-Ba6PlpQW.js";async function B(s){const i="https://script.google.com/macros/s/AKfycbyYcP7RYVblm2fGpjW294wTvUt84cXXSGs3G1hnoDSJTfTCMOMUqyjKd4JmHgjGE8z3Xw/exec";console.log("📧 Email Sending Started"),console.log("Script URL:",i),console.log("Email To:",s.to),console.log("Subject:",s.subject);try{console.log("📤 Sending request to Google Apps Script...");const n=await fetch(i,{method:"POST",mode:"no-cors",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});return console.log("✅ Request sent successfully (no-cors mode, response not available)"),{success:!0}}catch(n){return console.error("❌ Failed to send email:",n),{success:!1,error:n instanceof Error?n.message:"Unknown error"}}}function G(s,i,n){const b=s.orderNumber||"FC-"+Math.random().toString(36).substr(2,9).toUpperCase(),d=s.items||[],m=s.total||0,r=s.shippingAddress||{},h=s.paymentMethod||"Cash on Delivery",p=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),x=d.map(t=>`
